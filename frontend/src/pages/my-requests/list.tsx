...
export const MyRequestsContent = () => {
    ...
    const fetchRequests = async (staffId: any) => {
        try {
            const response = await axios.get(`${backendUrl}/api/v1/getOwnPendingRequests`, {
                params: { myId: staffId },
            });
    ...
    const handleCancel = async (requestId: number) => {
        try {
            const response = await axios.post(`${backendUrl}/api/v1/cancelPendingRequests`, { 
            ...
            if (response.status == 200){
                ...
                toast.open({
                    ...
                    description: "There was a problem cancelling your request. Please try again.",
                    type: "error",
                });
